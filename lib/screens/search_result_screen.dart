...
class searchResult extends StatefulWidget {
  searchResult({required this.temp,required this.humidity,required this.description,required this.currently,required this.name, required this.icon, required this.feels_like,required this.speed});
  var temp;
  var description;
  var speed;
  var currently;
  ...
  State<StatefulWidget> createState() {
    ...
    return _searchResultState(currently: currently,description: description,feels_like: feels_like,icon: icon,humidity: humidity,name: name,speed: speed,temp: temp);
  }

}

class _searchResultState extends State<searchResult> {
  _searchResultState({required this.temp,required this.humidity,required this.description,required this.currently,required this.name,required this.icon,required this.feels_like,required this.speed});
  var temp;
  var description;
  var speed;
  var currently;
